...
// Mocking data lookup context based on the passed _id string
const propertyData = {
  _id: "6a3518c465cbca76c268cb3e",
  title: "The Azure Penthouse",
  description:
    "Exquisite top-floor luxury penthouse with panoramic ocean vistas, private infinity pool, and custom marble finishes throughout. Perfect for short-term premium getaways.",
  ...
  extraFeatures:
    "Helipad access available upon request, private chef catering optional.",
  status: "Approved",
  rejectionFeedback: "",
  ownerInfo: {
    name: "Sarah Jenkins",
    email: "sarah.owner@havenstay.com",
  },
};
  ...
  return (
    <main className="min-h-screen py-12 px-4 md:px-8 max-w-7xl mx-auto text-gray-900">
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <span className="bg-indigo-50 text-primary text-[11px] font-bold tracking-wider uppercase px-2.5 py-1 rounded-md">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="space-y-6 lg:sticky lg:top-8">
          <div className="bg-white border border-gray-100 rounded-3xl p-6 shadow-sm space-y-4">
            ...
            <div className="space-y-2.5 text-[11px] text-gray-500 font-semibold bg-gray-50/50 p-3.5 rounded-xl border border-gray-100/50">
